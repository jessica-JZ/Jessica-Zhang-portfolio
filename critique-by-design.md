...
I used ChatGPT and Codex to help me interpret the assignment requirements, check percentage calculations, organize anonymized peer-feedback notes, and edit the written explanation. I made the chart-selection and redesign decisions and built the visualizations in Tableau.
