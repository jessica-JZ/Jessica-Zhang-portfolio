...
parts = [
    ...
    '<text x="70" y="58" class="title">File dominated release-version counts; vinyl releases remained</text>',
...
parts.append('<text x="28" y="585" text-anchor="middle" transform="rotate(-90 28 585)" class="subtitle">Percentage of release versions that include each format</text>')
...
parts.append('<text x="70" y="1148" class="note">Formats overlap for 0.16% of filtered release versions; these are catalog records, not market share or listening data.</text>')
parts.append('</svg>')
